...
def _compact(result: dict[str, Any]) -> dict[str, Any]:
  return {
    ...
    "cold_sequence": result.get("cold_sequence", {}),
    "outreach_template": result.get("outreach_template"),
    "cold_strategy_angles": result.get("cold_strategy_angles", {}),
    "cold_deliverability": result.get("cold_deliverability", {}),
