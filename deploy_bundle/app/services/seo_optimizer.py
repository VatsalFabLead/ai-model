...
from app.engine.seo_optimizer_rag_pipeline import run_optimizer_rag_pipeline
...
async def optimize(
  ...
  *,
  ...
  from app.engine.seo_optimizer_rag_pipeline import is_optimizer_instruction_content
